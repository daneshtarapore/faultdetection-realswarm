...
public:
    ...
    private:
        ...
        //std::list<Real> list_Dist_MediumRangeTimeWindow, list_Dist_LongRangeTimeWindow;
        std::vector<Real> list_Dist_MediumRangeTimeWindow, list_Dist_LongRangeTimeWindow;
        /************************************************************************************/
    };
    ...
    virtual unsigned GetIdFromRABPacket(CCI_EPuckPseudoRangeAndBearingSensor::TPackets &rab_packet, size_t rab_packet_index);
    virtual unsigned GetIdFromRABPacket(CCI_EPuckPseudoRangeAndBearingSensor::TPackets &rab_packet, size_t rab_packet_index, unsigned &range);
    virtual float    GetAnguAccelerFromRABPacket(CCI_EPuckPseudoRangeAndBearingSensor::TPackets &rab_packet, size_t rab_packet_index, unsigned observerd_robot_id);
